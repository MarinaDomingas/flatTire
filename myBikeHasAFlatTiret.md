...
In order to fix a flat tire, the first thing to do is to make sure that the bike is parked in a safety area, away from traffic and on a flat surface.

Then, check if the tire is really damaged or if it is just empty.

For that, thoroughly inspect the tire and look for any [signs of tears, punctures or for something that might be stuck on it](#Find-the-cause-of-the-flat).

If you find none, probably the tire is just empty and in need of being pumped up.

If you inflate the tire and the air continues to escape, it's time to consider changing the tire.
...
To change a flat tire please follow the steps below:
...
- [Patch or replace the tube](#Patch-or-replace-the-tube): Decide if it's better to patch or to change the tire.

- [Reinstall the wheel](#Reinstall-the-wheel): Put the wheel back in place, so that you can enjoy your bike again.
...
- If necessary, you can turn the bike upside down to work on it.
- Remember to remove the panniers and other bags beforehand to prevent damaging them.

**2. Disconnect the brakes, if they're in the way of taking off the wheel**
- if the bike has rim brakes, you’ll need to release your brakes.
- If the bike has v-brakes, squeeze the brake arms together to ease the tension so you can release the cable.
...
- Loosen the chain by adjusting the gears.
- Shift the chain onto the smallest cog of the rear cassette.
...
- Practice taking the wheel out before it is actually needed. It will be faster and easier when you actually need to do it.

## Remove the inner tube

**1. Deflate the bike tire completely.**
There are two ways of doing it, depending on the valve
...
- Remove the inflatable tube from beneath the tire by pulling the valve stem out through the rim first (be careful the rim edges are sharp). The rest of the tube should slide out easily when pulled. 

**Tip:** If you don't have a tire lever, you can do it anyway, it's just a bit more difficult. Unseat the tire bead by pushing the bead edge in toward the center of the rim and working your way around the rim. Then move the bead of the tire up and over the outside edge of the rim. 
...
- Remove anything that might damage the tube.
...
- If you don't see any obvious punctures or blowouts, inflate the tube to check for escaping air.
...
Also, if the damage is too extensive or severe to patch, a patch job failed to hold or the tube’s valve is damaged, the tire should be replaced.
In any other case, you can try to fix it.

**To repair a damaged tube, sand and glue the damaged spot, then affix a repair kit patch**
...
**2. Rough up the surface of the damaged area with sandpaper
...
**2. If the tire was completely removed from the rim, push one edge of the tire inside the rim**
...
- Check the pressure with a tire gauge. An improperly inflated tire is more likely to get a hole or tear in it.
...
**And you're done! You successfully changed a flat tire! Now, go for a ride :)**
